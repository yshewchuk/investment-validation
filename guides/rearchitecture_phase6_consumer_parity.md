...
Schema `phase6_capability_matrix.v1.0`: 214 discovered entrypoints, 47 capability rows, 19 excluded tooling entrypoints, 91 adapter edges.

Rows per disposition: native 15, compatibility-adapter 29, CLI-with-user-acceptance-needed 0, missing 1, dormant-historical 2.

Rows per owner: 8A 2, P6-2 15, P6-3 10, P6-4 16, P6-5 4.

...
Schema `phase6_capability_matrix.v1.0`: 192 discovered entrypoints, 46 capability rows, 12 excluded tooling entrypoints, 82 adapter edges.

Rows per disposition: native 8, compatibility-adapter 26, CLI-with-user-acceptance-needed 0, missing 10, dormant-historical 2.

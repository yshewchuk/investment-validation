...
Schema `phase6_capability_matrix.v1.0`: 224 discovered entrypoints, 48 capability rows, 19 excluded tooling entrypoints, 91 adapter edges.
...
| `models-training` | Retrain current model roles and register candidates | `cli:engine/models/training/train_all.py`<br>`cli:tools/build_chooser_pool.py` | `cli:tools/phase5_training_job.py`<br>`py:engine/v2/models/deployment.py::promote`<br>`py:engine/v2/ops/training.py::training_plan`<br>`py:engine/v2/ops/training.py::promote_plan`<br>`py:engine/v2/ops/training.py::training_job_kind`<br>`py:engine/v2/ops/training.py::promote_job_kind` | P5-3 supervised training job over legacy dataset builders; P5-5 staged deployment | training receipt + staged ModelRelease id | `tests/test_training.py`<br>`tests/test_v2_models_deployment.py`<br>`tests/test_v2_models_phase5_datasets.py` | compatibility-adapter | P6-2 |

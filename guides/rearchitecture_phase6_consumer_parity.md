...
Schema `phase6_capability_matrix.v1.0`: 201 discovered entrypoints, 46 capability rows, 14 excluded tooling entrypoints, 88 adapter edges.

Rows per disposition: native 11, compatibility-adapter 30, CLI-with-user-acceptance-needed 0, missing 3, dormant-historical 2.

Rows per owner: 8A 2, P6-2 15, P6-3 10, P6-4 15, P6-5 4.

Adapter edges per owner: 8A 2, P3B 12, P4 36, P5 9, P6-2 4, P6-3 9, P6-4 15, P6-5 1.

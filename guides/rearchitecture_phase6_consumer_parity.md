...
Schema `phase6_capability_matrix.v1.0`: 195 discovered entrypoints, 46 capability rows, 12 excluded tooling entrypoints, 87 adapter edges.

Rows per disposition: native 8, compatibility-adapter 29, CLI-with-user-acceptance-needed 0, missing 7, dormant-historical 2.

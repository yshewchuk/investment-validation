...
Schema `phase6_capability_matrix.v1.0`: 191 discovered entrypoints, 46 capability rows, 12 excluded tooling entrypoints, 87 adapter edges.

Rows per disposition: native 6, compatibility-adapter 29, CLI-with-user-acceptance-needed 1, missing 8, dormant-historical 2.

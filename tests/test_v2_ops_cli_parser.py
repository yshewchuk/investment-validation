...
_CASES = [
    ...
    ("plan_defaults", ["plan", "nightly"],
     {"activate_ledger": False, "as_of": None, "alpha": None, "command": "plan",
      "context_tickers": "",
      "expected_population": None, "full_run": False, "input_manifest": None,
      "input_mode": "legacy", "kind": "nightly", "mode": "shadow", "no_ledger": False,
      "cutoff": [], "pairs": "", "recipe": "", "refresh_mode": "legacy",
      "refresh_plan": None, "release_id": "", "release_root": "",
      "root": "data/operations", "snapshot_scope": None, "spec": None,
      "state": "", "strategy": [], "ticker_chunk": 1000, "tickers": "",
      "training_mode": None, "year_end": 2026, "year_start": 2024}),
    ("plan_explicit", ["plan", "experiment", "--as-of", "2026-02-01", "--mode", "shadow",
     ...
     {"activate_ledger": False,
      "as_of": "2026-02-01", "alpha": None, "command": "plan", "context_tickers": "AAPL,MSFT,SPY",
      "expected_population": Path("ep.json"), "full_run": True,
      "input_manifest": Path("im.json"), "input_mode": "snapshot", "kind": "experiment",
      "mode": "shadow", "no_ledger": True, "cutoff": [], "pairs": "", "recipe": "",
      "refresh_mode": "native", "refresh_plan": Path("rp.json"), "release_id": "",
      "release_root": "", "root": "data/operations", "snapshot_scope": "shadow2",
      "spec": Path("spec.json"), "state": "", "strategy": [], "ticker_chunk": 1000,
      "tickers": "AAPL,MSFT", "training_mode": None, "year_end": 2021, "year_start": 2020}),
    ...
    ("decisions_supersede",
     ["decisions", "supersede", "--row-id", "r1", "--reason", "x", "--from-json", "p.json"],
     {"command": "decisions", "decisions_command": "supersede", "from_json": Path("p.json"),
...
_ERROR_CASES = [
    ...
    ("decisions_supersede_missing_from_json",
